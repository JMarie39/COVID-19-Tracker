...
/**	The PanelOfficial_Tracer is the display panel for the create tracer account option of the official.	*/
public class PanelOfficial_Tracer extends JPanel {
	...
	/**	The constructor creates the GUI create tracer panel	*/
	public PanelOfficial_Tracer() {
		
		setBackground(new Color(95, 158, 160));
		setBounds(0, 0, 575, 503);
		setLayout(null);
		
		JLabel lblTerminate = new JLabel("CREATE TRACER ACCOUNT");
		lblTerminate.setBounds(21, 11, 435, 46);
		...
		txtUsername.setBounds(10, 11, 312, 18);
	...
	/**	This method sets an error message in the label (if account is a government official).	*/
	public void ErrorOfficial() {
		lblErrorMessage.setText("This account is a government official account.");
	}
	
	/**	This method sets an error message in the label (if account already is a tracer account).	*/
	public void ErrorTracer() {
		lblErrorMessage.setText("This account is already a contact tracer account.");
	}
